...
extension AppAttest {
    ...
    public struct AttestationResult: Codable {
        ...
        internal init(publicKey: P256.Signing.PublicKey, receipt: Data) {
        ...
        public func encode(to encoder: any Encoder) throws {
            ...
            try container.encode(publicKey.x963Representation, forKey: .publicKey)
            try container.encode(receipt, forKey: .receipt)
        }
        
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.publicKey = try P256.Signing.PublicKey(x963Representation: container.decode(Data.self, forKey: .publicKey))
